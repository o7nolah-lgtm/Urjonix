  ...
  return (
    <div style={{ textAlign: 'center', padding: '1.5rem 1rem' }}>
      <div ref={ref} style={{
        ...
        backgroundClip: 'text', lineHeight: 1, marginBottom: '0.5rem',
      }}>
        0{suffix}
      </div>
      <p style={{
        fontFamily: '"JetBrains Mono", monospace', fontSize: '0.58rem',
        letterSpacing: '0.16em', color: '#6C6C6C', textTransform: 'uppercase',
      }}>
        {label}
      </p>
    </div>
...
export function Home() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      gsap.from('.hero-headline', { opacity: 0, y: 40, duration: 1.1, ease: 'power3.out', delay: 0.3 })
      gsap.from('.hero-sub',      { opacity: 0, y: 30, duration: 1,   ease: 'power3.out', delay: 0.55 })
    ...
    <main ref={pageRef}>
      ...
      <section class="hero-grid">
        ...
        <div class="hero-text-col" style={{
          ...
          <p class="mono-label hero-headline" style={{ marginBottom: '1.5rem', color: '#D4AF37' }}>
      ...
      <section class="section-px" style={{
        ...
        <div style={{ maxWidth: '780px' }}>
          ...
          <h2 class="gsap-hidden" style={{
            fontFamily: '"Inter Tight", sans-serif', fontWeight: 800,
            fontSize: 'clamp(1.8rem, 4vw, 3.5rem)', letterSpacing: '-0.03em',
            color: '#ffffff', lineHeight: 1.1, marginBottom: '2rem',
          }}>
          ...
          <p class="gsap-hidden" style={{
            fontSize: 'clamp(0.85rem, 2vw, 1rem)', color: '#A1A1A1',
      ...
      <section style={{
        ...
        <div style={{
          ...
          {[
            ...
            <div key={s.label} style={{ borderRight: '1px solid rgba(161,161,161,0.08)' }}>
              <StatItem {...s} />
            </div>
          ))}
        </div>
      ...
      <section class="section-px" style={{
        ...
        <div class="gsap-hidden" style={{
          ...
          gap: '2rem', background: 'rgba(212,175,55,0.02)',
          ...
          {[
            ...
            <div key={i} style={{
              ...
              borderTop:    (pos.top    === 0) ? '1px solid #D4AF37' : 'none',
              borderBottom: (pos.bottom === 0) ? '1px solid #D4AF37' : 'none',
              borderLeft:   (pos.left   === 0) ? '1px solid #D4AF37' : 'none',
              borderRight:  (pos.right  === 0) ? '1px solid #D4AF37' : 'none',
            }} />
          ))}

          <div>
            <p class="mono-label" style={{ marginBottom: '0.75rem', color: '#D4AF37' }}>Ready to Scale</p>
            <h2 style={{
              fontFamily: '"Inter Tight", sans-serif', fontWeight: 800,
              fontSize: 'clamp(1.6rem, 3vw, 2.8rem)', letterSpacing: '-0.02em', color: '#ffffff',
            }}>
              Scaling the Future.
            </h2>
          </div>
