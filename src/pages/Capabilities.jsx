    ...
    <section style={{
      ...
      <div style={{
        ...
        <div style={{ padding: '2.5rem 0 0.5rem' }}>
          <p style={{
            color: 'var(--clr-med)', fontSize: '0.92rem', lineHeight: 1.8,
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1rem' }}>
            {[
              ...
              <div key={label} style={{
                ...
                <p style={{ fontSize: '0.82rem', color: 'var(--clr-bright)', fontWeight: 600 }}>{val}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div class="gsap-hidden" style={{ maxWidth: '1100px', margin: '0 auto', position: 'relative' }}>
        ...
        <button
          ...
          style={{
            ...
            alignItems: 'center',
            gap: '8px',
            background: 'rgba(var(--clr-bg-rgb),0.82)',
          ...
          <div style={{
            ...
            {[
              ...
              <div key={label} style={{
                ...
                borderRight: '1px solid var(--clr-border-faint)',
                transition: 'background 0.35s ease',
              }}>
                <p style={{
                  fontFamily: '"JetBrains Mono", monospace',
                ...
                <p style={{ fontSize: '0.82rem', color: 'var(--clr-light)' }}>{val}</p>
              </div>
            ))}
          </div>
        </div>
